...
export default function DarkModeSwitch() {
  ...
  return (
    <div
      ...
      className={`flex-start items-center flex h-[28px] w-[52px] rounded-full bg-zinc-100 p-[5px] mr-2 shadow-inner hover:cursor-pointer dark:bg-zinc-700 place-content-start ${
