    ...
    <DefaultLayout title="Manual de usuario">
      <div className="px-6 py-8 md:px-10 md:py-14">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div>
            <h4 className="text-md font-medium">3.1 Añadir nuevos cursos</h4>
            <Image
              src="/images/funcionalities/admin-func-1.png"
              alt="bg-header"
              width="0"
              height="0"
              sizes="100vw"
            ...
            />
            <Image
              src="/images/funcionalities/admin-func-2.png"
              alt="bg-header"
              width="0"
              height="0"
              sizes="100vw"
          ...
          <div>
            <h4 className="text-md font-medium">
              3.2 Editar o borrar usuarios
            </h4>
            <Image
              src="/images/funcionalities/admin-func-3.png"
              alt="bg-header"
              width="0"
              height="0"
              sizes="100vw"
            ...
            />
            <Image
              src="/images/funcionalities/admin-func-4.png"
              alt="bg-header"
              width="0"
              height="0"
              sizes="100vw"
